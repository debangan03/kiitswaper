...
function ClientData({ login }) {
    ...
    const submitres = async (e) => {
        ...
        e.preventDefault();
        const data = { name: name, phone: phone, email: em, roll: roll, branch: branch, year: year, semester: semester, section: section }
    ...
    return (
        <>
            <ToastContainer
                ...
                theme="light"
            />
            <h1 className='my-10 text-center text-2xl font-semibold'>Enter your details here</h1>
